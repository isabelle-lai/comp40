...
# 
# Includes build rules ADD LATER
#
...
40image-6: 40image.o compress40.o uarray2.o uarray2b.o a2plain.o a2blocked.o \
		 rgb_to_comp_vid.o arith_structs.o blocked_comp_vid.o \
		 scaled_comp_vid.o pack_word.o bitpack.o process_compressed_image.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS) 

clean:
	rm -f 40image-6 ppmdiff *.o
